...
class pantallaPrincpipal_pagina_agenda_estudiante extends StatefulWidget {

  @override
  State<pantallaPrincpipal_pagina_agenda_estudiante> createState() => _pantallaPrincpipal_pagina_agenda_estudianteState();
}

class _pantallaPrincpipal_pagina_agenda_estudianteState extends State<pantallaPrincpipal_pagina_agenda_estudiante> {
  final Color lighterColor = Color(0xFFCCEBB5); // Color más claro que FFAADD73

  @override
  Widget build(BuildContext context) {
    final eventosGuardados = Provider.of<EventosProviderEstu>(context).eventosGuardados;
