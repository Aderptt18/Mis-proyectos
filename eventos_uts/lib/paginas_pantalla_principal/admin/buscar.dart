...
class pantallaPrincpipal_pagina_buscar_admin extends StatefulWidget {
  @override
  State<pantallaPrincpipal_pagina_buscar_admin> createState() =>
      _pantallaPrincpipal_pagina_buscar_adminState();
}

class _pantallaPrincpipal_pagina_buscar_adminState
    extends State<pantallaPrincpipal_pagina_buscar_admin> {
  String searchQuery = "";
