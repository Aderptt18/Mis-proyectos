...
class pantallaPrincpipal_pagina_crear_admin extends StatefulWidget {
  @override
  State<pantallaPrincpipal_pagina_crear_admin> createState() =>
      _pantallaPrincpipal_pagina_crear_adminState();
}
class _pantallaPrincpipal_pagina_crear_adminState
    extends State<pantallaPrincpipal_pagina_crear_admin> {
  ...
  registroEvento(String urlImagen) async {
    try {
      await firebase.collection('eventos').doc().set({
              ...
              child: ElevatedButton(
                onPressed: () async {
                  if (imagen_a_subir == null) {
                    ...
                    await subirImagen(imagen_a_subir!, (String url) {
                      setState(() {
                        this.url = url;
                      });
                    }, nombreController);
